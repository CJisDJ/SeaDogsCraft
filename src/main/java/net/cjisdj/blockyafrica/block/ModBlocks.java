package net.cjisdj.blockyafrica.block;

import net.cjisdj.blockyafrica.BlockyAfrica;
import net.cjisdj.blockyafrica.block.custom.SoundBlock;
...
public class ModBlocks {
    public static final DeferredRegister<Block> BLOCKS =
            DeferredRegister.create(ForgeRegistries.BLOCKS, BlockyAfrica.MOD_ID);
