...
import net.cjisdj.seadogscraft.entity.procedures.CaptainEntityIsHurtProcedure;
...
public class CaptainEntity extends Monster {
	...
	public CaptainEntity(EntityType<CaptainEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 0;
		setNoAi(false);
	...
	public static void init() {
		SpawnPlacements.register(SeaDogsCraftModEntities.CAPTAIN.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
