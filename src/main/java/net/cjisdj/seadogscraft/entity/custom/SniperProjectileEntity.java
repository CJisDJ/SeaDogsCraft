...
public class SniperProjectileEntity extends Projectile {
    private static final EntityDataAccessor<Boolean> HIT =
            SynchedEntityData.defineId(SniperProjectileEntity.class, EntityDataSerializers.BOOLEAN);
    private int counter = 0;
    private boolean hasHit = false;

    public SniperProjectileEntity(EntityType<? extends Projectile> pEntityType, Level pLevel) {
        super(pEntityType, pLevel);
    }

    public SniperProjectileEntity(Level pLevel, Player player) {
