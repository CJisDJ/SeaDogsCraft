...
public class SwordmanEntity extends Monster {
	public SwordmanEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(SeaDogsCraftModEntities.SWORDMAN.get(), world);
	}

	public SwordmanEntity(EntityType<SwordmanEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 0;
		setNoAi(false);
	...
	protected void registerGoals() {
		super.registerGoals();
		this.goalSelector.addGoal(1, new LookAtPlayerGoal(this, Player.class, (float) 4));
	...
	public void playStepSound(BlockPos pos, BlockState blockIn) {
		this.playSound(ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("entity.villager.ambient")), 0.15f, 1);
	}
	...
	public static void init() {
		SpawnPlacements.register(SeaDogsCraftModEntities.SWORDMAN.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
