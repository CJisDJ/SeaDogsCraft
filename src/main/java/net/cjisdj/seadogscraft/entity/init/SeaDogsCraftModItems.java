...
public class SeaDogsCraftModItems {
	...
	public static final RegistryObject<Item> CAPTAIN_TRADER_SPAWN_EGG = REGISTRY.register("captain_trader_spawn_egg", () -> new ForgeSpawnEggItem(SeaDogsCraftModEntities.CAPTAIN_TRADER, -3342439, -1, new Item.Properties()));
}
