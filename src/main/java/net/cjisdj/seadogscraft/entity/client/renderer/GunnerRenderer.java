...
public class GunnerRenderer extends HumanoidMobRenderer<GunnerEntity, HumanoidModel<GunnerEntity>> {
	...
	public ResourceLocation getTextureLocation(GunnerEntity entity) {
		return new ResourceLocation("seadogscraft:textures/entity/gunner.png");
	}
}
